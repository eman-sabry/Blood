      ...
      <div className="space-y-6">
        {pendingHospitals.length > 0 ? (
          pendingHospitals.map((h) => (
            <div
              key={h.id}
              className="bg-white border border-gray-100 rounded-[2.5rem] p-8 shadow-sm  transition-all group relative overflow-hidden"
            >
              <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 flex-1 max-w-2xl relative z-10">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-sm font-bold text-slate-400 break-words max-w-[180px] italic">
                ...
                <div className="flex items-center gap-3 relative z-10">
                  <button
                    ...
                    className="flex-1 md:flex-none px-4 py-4 text-white rounded-2xl font-black text-sm bg-green-600 hover:bg-green-700  active:scale-95 transition-all"
                  >
                    Approve
                  </button>
                  <button
